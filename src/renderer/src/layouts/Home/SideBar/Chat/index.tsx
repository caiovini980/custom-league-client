...
import { AddFriendIcon } from '@render/layouts/Home/SideBar/Chat/AddFriend/AddFriendIcon';
import { ChatItem } from '@render/layouts/Home/SideBar/Chat/ChatItem';
import { SearchFriend } from '@render/layouts/Home/SideBar/Chat/SearchFriend';
import {
  ProfileModal,
  ProfileModalRef,
