...
import { ContinueButton } from '@render/layouts/Lobby/PreEndGame/ContinueButton';
import {
  HonorCard,
  HonorCardContainer,
} from '@render/layouts/Lobby/PreEndGame/HonorScreen/HonorCard';
  ...
  return (
    ...
    >
      ...
      <Stack direction={'column'} alignItems={'center'} rowGap={1}>
        <ContinueButton onClickContinue={onClickContinue} />
      </Stack>
    </Stack>
  );
};
