import { IpcFunctionObjectMapper, IpcMainToRendererObjectMapper } from '@shared/typings/ipc.typing'
  ...
  static init() {
    ...
    Object.keys(ipcFunctionObjectMapper)
      .reduce((previousValue, currentValue: keyof IpcFunctionObjectMapper) => {
        const functionNameList = Object.keys(ipcFunctionObjectMapper[currentValue])
